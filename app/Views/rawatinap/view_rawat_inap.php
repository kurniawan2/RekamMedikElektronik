        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Cari Data Dokter</h4>
                        ...
                        <tbody>
                            ...
                            foreach ($dokter as $row) : $no++ ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm btn-pilih" data-id="<?= $row['id_dokter']; ?>" data-nama="<?= $row['nama_dokter']; ?>">
                        ...
                        <tbody>
                            ...
                            foreach ($pasien as $row) : $no++ ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm btn-pilih2" data-id="<?= $row['id_pasien']; ?>" data-nama="<?= $row['nama_pasien']; ?>" data-alamat="<?= $row['alamat_pasien']; ?>" data-noruang="<?= $row['no_rm_pasien']; ?>" data-nohp="<?= $row['nohp_pasien']; ?>">
                                            <i class="fa fa-tags"></i> Pilih
                                        </button>
                                    </td>
                                </tr>
                        ...
                        <tbody>
                            ...
                            foreach ($poli as $row) : $no++ ?>
                                <tr>
                                    ...
                                    <td> <?= $row['nama_poli']; ?></td>
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm btn-pilih3" data-id="<?= $row['id_poli']; ?>" data-nama="<?= $row['nama_poli']; ?>">
                                            <i class="fa fa-tags"></i> Pilih
                                        </button>
                                    </td>
                                </tr>
                        ...
                        <tbody>
                            ...
                            foreach ($ruangan as $row) : $no++ ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm btn-pilih4" data-id="<?= $row['id_ruangan']; ?>" data-nama="<?= $row['nama_ruangan']; ?>">
                                            <i class="fa fa-tags"></i> Pilih
                                        </button>
                                    </td>
                                </tr>
